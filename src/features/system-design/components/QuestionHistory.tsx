...
import type { ConstructiveQuestion, ConversationMessage } from '../types/layer1.types';
...
export function QuestionHistory({ questions, conversation }: QuestionHistoryProps) {
  const qaHistory = deriveQuestionAnswersFromConversation(conversation);
